<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Profile.aspx.cs" Inherits="IT2163_Assignment1_202578M.Profile" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <asp:Button class="btn btn-warning" type="submit" OnClick="ChangePassword" runat="server" Text="Change" ID="Button1" />
        </div>
        <div class="card-footer text-muted text-center">
            <asp:Button class="btn btn-primary" type="submit" OnClick="LogoutMe" runat="server" Text="Logout" ID="LogoutBtn" />
        </div>
    </div>
